...
class ProductResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'rating_average' => $this->shows_rating_summary ? $this->rating_average : null,
            'review_count' => $this->review_count,
            'rating_display_state' => $this->rating_display_state,
            'shows_rating_summary' => $this->shows_rating_summary,
            'shows_new_badge' => $this->shows_new_badge,
