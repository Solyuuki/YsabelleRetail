...
class StorefrontAssistantMessageNormalizer
{
    public function normalize(string $message, array $assistantContext = []): array
    {
        ...
        return [
            ...
            'has_commerce_buyer_signal' => $this->containsAny($normalized, [
                'affordable',
                'budget',
                'find',
                'have',
    ...
    private function replaceAliases(string $message, array $assistantContext): string
    {
        $patterns = [
            ...
            '/\b(meron ba kayo|meron bang|meron ba|mayroon ba kayong|mayroong)\b/u' => ' have ',
            '/\b(hanap moko|hanap mo ko|hanap ako|hanapan|hanap|pahanap)\b/u' => ' find ',
            '/\b(sapatos)\b/u' => ' shoes ',
            '/\b(mura)\b/u' => ' affordable budget ',
